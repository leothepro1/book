...
const PARITY_CASES: ParityCase[] = [
  ...
  },
  {
    ...
    fixtures: [
      ...
      },
      {
        ...
        payload: { ...CTX, cart_id: "", accommodation_id: "a_1", cart_total: CART_TOTAL_VALID },
        ok: false,
      },
      {
      ...
      },
      {
        ...
        payload: { ...CTX, cart_id: "c_1", accommodation_id: "a_1", cart_total: { amount: 100, currency: "SE" } },
        ok: false,
      },
      {
        label: "invalid: amount float",
        payload: { ...CTX, cart_id: "c_1", accommodation_id: "a_1", cart_total: { amount: 100.5, currency: "SEK" } },
        ok: false,
      },
      {
        label: "invalid: cart_total missing",
        payload: { ...CTX, cart_id: "c_1", accommodation_id: "a_1" },
        ok: false,
      },
    ],
  },
  {
    ...
    fixtures: [
      ...
      {
        label: "valid: zero items (post-removal)",
        payload: { ...CTX, cart_id: "c_1", items_count: 0, cart_total: { amount: 0, currency: "SEK" }, action: "removed" },
        ok: true,
      },
      {
        label: "valid: quantity_changed",
        payload: { ...CTX, cart_id: "c_1", items_count: 3, cart_total: CART_TOTAL_VALID, action: "quantity_changed" },
        ok: true,
      },
      {
      ...
      },
      {
        ...
        payload: { ...CTX, cart_id: "c_1", items_count: -1, cart_total: CART_TOTAL_VALID, action: "added" },
        ok: false,
      },
      {
        label: "invalid: items_count missing",
        payload: { ...CTX, cart_id: "c_1", cart_total: CART_TOTAL_VALID, action: "added" },
        ok: false,
      },
    ],
  },
  {
    ...
    fixtures: [
      ...
      {
        label: "invalid: items_count zero (must be positive — distinct from cart_updated)",
        payload: { ...CTX, cart_id: "c_1", items_count: 0, cart_total: CART_TOTAL_VALID, time_since_last_interaction_ms: 90_000 },
        ok: false,
      },
      {
        label: "invalid: items_count negative",
        payload: { ...CTX, cart_id: "c_1", items_count: -1, cart_total: CART_TOTAL_VALID, time_since_last_interaction_ms: 90_000 },
        ok: false,
      },
      {
        label: "invalid: time_since_last_interaction_ms negative",
        payload: { ...CTX, cart_id: "c_1", items_count: 1, cart_total: CART_TOTAL_VALID, time_since_last_interaction_ms: -1 },
        ok: false,
      },
      {
        label: "invalid: cart_id missing",
        payload: { ...CTX, items_count: 2, cart_total: CART_TOTAL_VALID, time_since_last_interaction_ms: 1000 },
        ok: false,
      },
    ],
  },
  {
    ...
    fixtures: [
      ...
      {
        label: "invalid: cart_id missing",
        payload: { ...CTX, items_count: 1, cart_total: CART_TOTAL_VALID },
        ok: false,
      },
      {
        label: "invalid: cart_total missing",
        payload: { ...CTX, cart_id: "c_1", items_count: 1 },
        ok: false,
      },
    ],
  },
