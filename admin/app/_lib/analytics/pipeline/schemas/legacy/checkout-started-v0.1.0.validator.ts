/**
 * Hand-rolled validator for checkout_started v0.1.0 — DEPRECATED.
 *
 * Mirrors the legacy Zod schema in `./checkout-started-v0.1.0.ts`.
 * Kept so the worker can still validate v0.1.0 events that were
 * emitted before the v0.2.0 migration drained from the outbox.
 *
...
export function validateCheckoutStartedV010Payload(
  payload: unknown,
): ValidationResult {
